...
//    float2 patternXY = voronoi(50.0 * viewDirection.xy);
//    float2 patternYZ = voronoi(50.0 * viewDirection.yz);
//    float2 patternZX = voronoi(50.0 * viewDirection.zx);
...
//
//
//float rayTrace(  float3 rayOrigin,  float3 rayDirection )
//{
...
//
//
//float calculateMinimumDistanceToEarth(float3 position) {
